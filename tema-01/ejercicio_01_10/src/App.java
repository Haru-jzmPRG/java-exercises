public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(AZUL + "██████████████████████" + NEGRO + "██" + AZUL + "██████████" + RESET);
        System.out.println(AZUL + "███" + FONDO_AZUL + "APRENDE JAVA" + AZUL + "█████" + NEGRO + "██" + AZUL + "████████████" + RESET);
        System.out.println(AZUL + "██" + FONDO_AZUL + "CON EJERCICIOS" + AZUL + "██████" + NEGRO + "██" + AZUL + "██████████" + RESET);
        System.out.println(AZUL + "██████████████████████████████████" + RESET);
        System.out.println(AZUL + "█" + FONDO_AZUL + "Jazmin Gutierrez" + AZUL + "█" + NEGRO + "████████████" + AZUL + "████" + RESET);
        System.out.println(AZUL + "██████████████████" + NEGRO +"████████" + AZUL + "██" + NEGRO + "██" + AZUL + "████" + RESET);
        System.out.println(AZUL + "██████████████████" + NEGRO + "████████████" + AZUL + "████" + RESET);
        System.out.println(AZUL + "██████████████████" + NEGRO +"████████" + AZUL +"████████" + RESET);
        System.out.println(AZUL + "░░░░░░░░░░░░░░░░░░" + NEGRO +"████████" + AZUL +"░░░░░░░░" + RESET);
        System.out.println(AZUL + "░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░" + RESET);
